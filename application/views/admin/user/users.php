                                ...
                                <tr>
                                    ...
                                    <td width="10%">
                                        ...
                                        <?php if($user['role'] == 'user'): ?>
                                            <div class="label label-table label-success">Tecnico</div>
                                        <?php endif ?>
                                        <?php if($user['role'] == 'Motorista'):?>
                                        <div class="label label-table label-success">Motorita</div>
                                        <?php endif ?>
                                    </td>
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <?php if ($this->session->userdata('role') == 'admin'): ?>
                                            <a href="<?php echo base_url('admin/user/update/'.$user['id']) ?>" data-toggle="tooltip" data-original-title="Editar"> <i class="fa fa-pencil text-success m-r-10"></i> </a>

                                            <a id="delete" data-toggle="modal" data-target="#confirm_delete_<?php echo $user['id'];?>"   data-toggle="tooltip" data-original-title="Eliminar"> <i class="fa fa-trash text-danger m-r-10"></i> </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-body">
                ...
                ¿Seguro que quieres eliminar? <br> <hr>
