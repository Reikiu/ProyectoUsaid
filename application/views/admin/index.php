                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard') ?>">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo base_url() ?>assets/images/logo.svg" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="<?php echo base_url() ?>assets/images/r1 (2).jpg" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
                         <!-- dark Logo text -->
                         <img src="<?php echo base_url() ?>" alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->    
                            <h3 class="light-logo" alt="homepage" >USAID</h3></span> </a>
                </div>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/user') ?>"><i class="fa fa-angle-right"></i> Agregar usuarios </a></li>
                                    <li><a href="<?php echo base_url('admin/user/power') ?>"><i class="fa fa-angle-right"></i> Agregar permisos</a></li>
                                <?php else: ?>
                                ...
                                <li><a href="<?php echo base_url('admin/user/all_user_list') ?>"><i class="fa fa-angle-right"></i> Lista usuario</a></li>
                            </ul>
                        </li>
<!--                        Esta parte es de crear actividades-->
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-file-text"></i><span class="hide-menu">Actividades</span></a>
                            <ul aria-expanded="false" class="collapse">

                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('actividades/agregarActividad') ?>"><i class="fa fa-angle-right"></i> Crear Actividad </a></li>
                                <?php else: ?>
                                <?php if(check_power(1)):?>
                                        <li><a href="<?php echo base_url('actividades/agregarActividad') ?>"><i class="fa fa-angle-right"></i> Crear Actividad </a></li>
                                    <?php endif; ?>
                                <?php endif ?>
                                <li><a href="<?php echo base_url('actividades') ?>"><i class="fa fa-angle-right"></i> Ver Actividad</a></li>

                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-file-text"></i><span class="hide-menu">Visita</span></a>
                            <ul aria-expanded="false" class="collapse">

                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('visita/agregarVisita') ?>"><i class="fa fa-angle-right"></i> Crear Visita </a></li>
                                <?php else: ?>
                                    <?php if(check_power(1)):?>
                                        <li><a href="<?php echo base_url('visita/agregarVisita') ?>"><i class="fa fa-angle-right"></i> Crear Visita </a></li>
                                    <?php endif; ?>
                                <?php endif ?>
                                <li><a href="<?php echo base_url('visita') ?>"><i class="fa fa-angle-right"></i> Ver Visita</a></li>


                            </ul>
                        </li>
                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('logistica') ?>" aria-expanded="false"><i class="fa fa-address-book"></i><span class="hide-menu">Logistica</span></a>
                        </li>
                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('asignarConductor') ?>" aria-expanded="false"><i class="fa fa-address-book"></i><span class="hide-menu">Asignar Conductor</span></a>
                        </li>
                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('resultado') ?>" aria-expanded="false"><i class="fa fa-address-book"></i><span class="hide-menu">Ver resultado</span></a>
                        </li>
                        <?php if ($this->session->userdata('role') == 'admin'): ?>
                            <li>
                                <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-wpforms"></i><span class="hide-menu">Reportes</span></a>
                                <ul aria-expanded="false" class="collapse">

                                    <li><a href="<?php echo base_url('reportes') ?>"><i class="fa fa-angle-right"></i> Reportes Municipio</a></li>
                                    <li><a href="<?php echo base_url('reportes/Reportesall') ?>"><i class="fa fa-angle-right"></i> Reportes general</a></li>
...
<!--    aqui estaran los link para validacion de formularios de usaid-->
    <script src="<?php echo base_url() ?>assets/src/js/Actividad/actividad.js"></script>
    <script src="<?php echo base_url() ?>assets/src/js/Visita/Visita.js"></script>
    <script src="<?php echo base_url() ?>assets/src/js/resultado/resultado.js"></script>
