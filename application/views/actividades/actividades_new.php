<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Actividad</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url('admin/dashboard') ?>">Inicio</a></li>
                <li class="breadcrumb-item active">Agregar nueva Actividad</li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Agregar nueva Actividad </h4>

                </div>
                <div class="card-body">
<form class="form-horizontal FormCatElec" action="insertarActividad" role="form" method="post" id="actividadesForm" enctype="multipart/form-data">

    <div class="form-group row">
        <div class="col-md-12"><h3>Registro de Actividad</h3></div>
        ...
        <div class="form-column col-md-6">
            <div class="form-group">
                <select name="Municipio" name="Municipio" class="form-control all-elements-tooltip"  >
        ...
        <div class="form-column col-md-6">
            <div class="form-group">
                ...
                <input class="form-control all-elements-tooltip" type="date" placeholder="Ingrese fecha inicio" required name="Fecha_Inicio" name="Fecha_Inicio" data-toggle="tooltip" data-placement="top" title="Ingrese Hora Retorno de oficina." maxlength="50">
            </div>
        </div>
        <div class="form-column col-md-6"><div class="form-group"></div></div>
        <div class="clearfix"></div>
        ...
        <div class="form-column col-md-6">
            <div class="form-group">
                <input class="form-control all-elements-tooltip" type="file" name="ruta" id="ruta" data-toggle="tooltip" data-placement="top" title="Ingrese documento.(solamente archivos)">
            </div>
        </div>
        <div class="form-column col-md-6"><div class="form-group"></div></div>
        <div class="clearfix"></div>
        ...
        <div class="form-column col-md-6">
            <div class="form-group">
                <textarea rows="3" cols="50" placeholder="Ingrese resultado"  name="resultado" data-toggle="tooltip" data-placement="top" title="Ingrese resultado.(solamente letras)" pattern="[a-zA-Z ]{1,50}" maxlength="50"></textarea>
            </div>
        </div>
        ...
        <div class="form-column col-md-6">
            <div class="form-group">
                <button type="submit"   class="btn btn-success" style="width: 485px" id="btnGuardar1" name="btnGuardar1">Guardar</button>
            </div>
        </div>
        <div class="clearfix"></div>
...
<!--en actividades va la parte de resultado-->