        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block "><img src="<?php echo base_url('resources/img/imglogin.png');?>" style="width: 125%; height: 85%"  alt=""></div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Bienvenido a USAID</h1>
                                    <?php
                                ...
                                <form action="login/login" name="frmLogin" class="user" id="frmLogin" method="POST">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="usuario" name="user">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password" name="password">
                                    </div>

                                    <input type="submit" name="ingrear" class="btn btn-primary btn-user btn-block">
                                    <button type="button" onclick="location.href='<?php echo site_url("registro") ?>'" class="btn btn-primary btn-user btn-block"> Registrarse </button>
