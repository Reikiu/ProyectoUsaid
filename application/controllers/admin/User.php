    ...
    {   
        if ($_POST) {
            ...
            if (empty($email)) {
                ...
                $this->session->set_flashdata('msg', 'Usuario agregado exitosamente');
                redirect(base_url('admin/user/all_user_list'));
            } else {
                $this->session->set_flashdata('error_msg', 'El correo electrónico ya existe, intente con otro correo electrónico');
